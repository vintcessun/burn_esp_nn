...
use esp_nn_sys::bindings::esp_nn_conv_s8_ansi as esp_nn_conv_s8;
#[cfg(any(feature = "esp32s3", feature = "esp32p4"))]
use esp_nn_sys::bindings::esp_nn_conv_s8_opt as esp_nn_conv_s8;
#[cfg(not(any(feature = "esp32s3", feature = "esp32p4")))]
use esp_nn_sys::bindings::esp_nn_get_conv_scratch_size_ansi as esp_nn_get_conv_scratch_size;
#[cfg(any(feature = "esp32s3", feature = "esp32p4"))]
use esp_nn_sys::bindings::esp_nn_get_conv_scratch_size_opt as esp_nn_get_conv_scratch_size;
#[cfg(not(any(feature = "esp32s3", feature = "esp32p4")))]
use esp_nn_sys::bindings::esp_nn_set_conv_scratch_buf_ansi as esp_nn_set_conv_scratch_buf;
#[cfg(any(feature = "esp32s3", feature = "esp32p4"))]
use esp_nn_sys::bindings::esp_nn_set_conv_scratch_buf_opt as esp_nn_set_conv_scratch_buf;
...
pub fn run(params: Conv2dParams<'_>) -> Status {
    ...
    unsafe {
        esp_nn_set_conv_scratch_buf(params.scratch.as_mut_ptr().cast::<c_void>());
        esp_nn_conv_s8(
            &input_dims,
            params.input.as_ptr(),
            &filter_dims,
